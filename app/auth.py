...
def activate():
    print("Estamos en esta parte ACTIVATE  ##################################################")
    try:
        if g.user:
...
def register():
    print("Estamos en esta parte REGISTER  ##################################################")
    try:
        if g.user:
            return redirect(url_for('inbox.show'))
...
def confirm():
    print("Estamos en esta parte CONFIrmar  #####")
    try:
        if g.user:
            return redirect(url_for('inbox.show'))
...
def login():
    print("Estamos en esta parte LOGIN  ##################################################")
    try:
        if g.user:
            return redirect(url_for('inbox.show'))
